...
<html>
	...
	<body>
		...
		<div id="kindlize" style="display: none;">
			<p>Use the Kindlize website like you would the rest of your Kindle, the page back and forward buttons will work as normal, and the back button on the keyboard will take you back a section.</p>
			<p>Unlike reading a book the Kindle will not automatically refresh the screen while reading websites, if your screen becomes unclear press <em>Alt+G</em> to refresh it.</p>
		</div>
	</body>
